    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-white fixed-top shadow-sm">
        <div class="container">
            <?php if ($_SESSION['user_type'] == 'vendor'): ?>
                <a class="navbar-brand fw-bold" href="<?php echo SITE_URL; ?>admin/vendors/dashboard.php">
                    <i class="fas fa-shopping-bag text-primary me-2"></i>
                    ShopEase<span class="text-primary">Pro</span>
                </a>
            <?php else: ?>
                <a class="navbar-brand fw-bold" href="<?php echo SITE_URL; ?>admin/dashboard.php">
                    <i class="fas fa-shopping-bag text-primary me-2"></i>
                    ShopEase<span class="text-primary">Pro</span>
                </a>
            <?php endif; ?>
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <?php else: ?>
                                    <li><a class="dropdown-item" href="<?php echo SITE_URL; ?>admin/vendors/dashboard.php">
                                        ...
                                        <li><a class="dropdown-item" href="<?php echo SITE_URL; ?>admin/vendors/profile.php">
                                            <i class="fas fa-user me-2"></i> My Profile
                                        </a>
                                    </li>
                                    <?php endif; ?>
