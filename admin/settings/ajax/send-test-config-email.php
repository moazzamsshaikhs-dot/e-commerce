...
try {
    ...
    $mail->Body    = '<h2>SMTP Configuration Test</h2>
                     <p>Your email configuration is working correctly!</p>
                     <p><strong>Server:</strong> ' . ($settings['smtp_host'] ?? 'localhost') . '</p>
                     <p><strong>Sent at:</strong> ' . date('Y-m-d H:i:s') . '</p>';
    $mail->AltBody = 'SMTP Configuration Test - Your email configuration is working correctly!';
