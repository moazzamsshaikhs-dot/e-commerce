...
// Get categories - اصل مسلہ یہاں ہو سکتا ہے
try {
    $db = getDB();
                ...
                <div>
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0">
                            ...
                            <li class="breadcrumb-item"><a href="<?php echo SITE_URL; ?>admin/vendors/products/products.php">Products</a></li>
                            <li class="breadcrumb-item"><a href="<?php echo SITE_URL; ?>admin/vendors/products/view.php?id=<?php echo $product_id; ?>">View</a></li>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <p class="text-muted">
                    This will remove the product from the store and delete all associated data.
...
// Helper functions for Danger Zone
