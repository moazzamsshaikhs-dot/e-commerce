...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    try {
        ...
        $stmt = $db->prepare("SELECT title FROM notifications WHERE id = ? AND user_id = ?");
        ...
        // Log activity
        logVendorActivity($vendor_id, 'mark_notification_read', "Marked notification #$notification_id as read: {$notification['title']}");
