...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        if ($action === 'update_shipping_settings') {
            ...
            ");
            $stmt->execute([
                $vendor_id, $processing_time, $handling_fee, $package_dimensions,
                $processing_time, $handling_fee, $package_dimensions
            ]);
                    ...
                    <div class="card-body">
                        <form method="POST" id="shippingSettingsForm">
                            ...
                            <div class="row g-4">
                                ...
                                <div class="col-12">
                                    <h6 class="fw-bold mb-3">Shipping From Address</h6>
                                    <div class="border rounded p-3 bg-light">
                                        <p class="mb-2">
                                            <i class="fas fa-map-marker-alt text-primary me-2"></i>
                                            <?php echo htmlspecialchars($shipping_settings['store_address'] ?? 'No address set'); ?>
                                        </p>
                                        <a href="../settings/settings.php#store" class="btn btn-sm btn-outline-primary">
                                            <i class="fas fa-edit me-2"></i> Update Address in Store Settings
                                        </a>
                                    </div>
                                </div>
