...
try {
    ...
    $inventory_params = array_merge($params, [$per_page, $offset]);
    $inventory_stmt->execute($inventory_params);
            ...
            <form method="POST" action="import.php" enctype="multipart/form-data">
                <div class="modal-body">
                    <div class="mb-3">
                        ...
                        <input type="file" name="inventory_file" class="form-control" accept=".csv,.xlsx,.xls" required>
                    ...
                    <div class="mb-3">
                        ...
                        <select name="import_action" class="form-select">
                            ...
                            <option value="add_update">Add new and update existing</option>
                        </select>
                    </div>
                    ...
                    <div class="alert alert-info">
                        <small>
                            ...
                            <a href="sample-inventory.csv" class="text-decoration-none">Download sample CSV file</a>
                        </small>
                    </div>
                </div>
...
function quickUpdateStock(productId, currentStock) {
    const productName = document.querySelector(`tr input[value="${productId}"]`).closest('tr').querySelector('h6').textContent;
