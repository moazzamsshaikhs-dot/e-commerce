                        ...
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                ...
                                <div class="h5 mb-0 font-weight-bold text-gray-800">
                                    <?php
                                    $selectAll = 'select count(*) as all_orders from orders';
                                    $allQuery = mysqli_query($conn, $selectAll);
                                    $allStats = mysqli_fetch_assoc($allQuery)
                                        ?>
                                    <?php echo $allStats["all_orders"] ?>
                                </div>
                            </div>
                            <div class="col-auto">
                        ...
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                ...
                                <div class="h5 mb-0 font-weight-bold text-gray-800">
                                    <?php
                                    $pending = 'pending';
                                    $selectPending = "select count(*) as pending_orders from orders where status = '$pending'";
                                    $pendingQuery = mysqli_query($conn, $selectPending);
                                    $pendingStats = mysqli_fetch_assoc($pendingQuery)
                                        ?>
                                    <?php echo $pendingStats["pending_orders"] ?>
                                </div>
                            </div>
                            <div class="col-auto">
                        ...
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                ...
                                <div class="h5 mb-0 font-weight-bold text-gray-800">
                                    ...
                                    $selectProcess = "select count(*) as process_orders from orders where status = '$processing'";
                                    $processQuery = mysqli_query($conn, $selectProcess);
                                    $processStats = mysqli_fetch_assoc($processQuery)
                                        ?>
                                    <?php echo $processStats["process_orders"] ?>
                                </div>
                            </div>
                            <div class="col-auto">
                        ...
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                ...
                                <div class="h5 mb-0 font-weight-bold text-gray-800">
                                    <?php
                                    $shipped = 'shipped';
                                    $selectShipped = "select count(*) as shipped_orders from orders where status = '$shipped'";
                                    $shippedQuery = mysqli_query($conn, $selectShipped);
                                    $shippedStats = mysqli_fetch_assoc($shippedQuery)
                                        ?>
                                    <?php echo $shippedStats["shipped_orders"] ?>
                                </div>
                            </div>
                            <div class="col-auto">
                        ...
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                ...
                                <div class="h5 mb-0 font-weight-bold text-gray-800">
                                    <?php
                                    $Delivered = 'Delivered';
                                    $selectDelivered = "select count(*) as Delivered_orders from orders where status = '$Delivered'";
                                    $DeliveredQuery = mysqli_query($conn, $selectDelivered);
                                    $DeliveredStats = mysqli_fetch_assoc($DeliveredQuery)
                                        ?>
                                    <?php echo $DeliveredStats["Delivered_orders"] ?>
                                </div>
                            </div>
                            <div class="col-auto">
                        ...
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                ...
                                <div class="h5 mb-0 font-weight-bold text-gray-800">
                                    ...
                                    $selectdate = "select Date(order_date) as date_orders, sum(total_amount) as total_sales from orders WHERE DATE(order_date) >= DATE_SUB(NOW(), INTERVAL 30 DAY)";
                                    $dateQuery = mysqli_query($conn, $selectdate);
                                    $dateStats = mysqli_fetch_assoc($dateQuery)
                                        ?>
                                    <?php echo $dateStats["total_sales"] ?>
                                </div>
                            </div>
                            <!-- <div class="col-auto">
