...
if ($_SESSION['user_type'] !== 'admin') {
    ...
    redirect('/e-commerce/admin/dashboard.php');
}
...
try {
    ...
    $stmt = $db->prepare("SELECT DISTINCT status FROM orders WHERE user_id = ? AND status != '' ORDER BY status");
    $stmt->execute([$user_id]);
    $order_statuses = $stmt->fetchAll(PDO::FETCH_COLUMN);
    
    // Get total spent
    $stmt = $db->prepare("SELECT COALESCE(SUM(total_amount), 0) as spent 
                          FROM orders 
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                <div class="d-flex justify-content-between mb-1">
                                    ...
                                    <span><?php echo $order['total_items'] ?? $order['items_count'] ?? 'N/A'; ?></span>
                                </div>
                                <div class="d-flex justify-content-between mb-1">
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <a href="reorder.php?id=<?php echo $order['id']; ?>" 
